...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <input class="form-control me-2" type="search" placeholder="Search Materials" name="query" aria-lable="Search">
        <button class="btn btn-outline-danger" type="submit">Search</button>
        </form>
        </li>
            <li class="nav-item"><a class="nav-link text-danger" href="#">Home</a></li>
            <li class="nav-item"><a class="nav-link text-danger" href="#">Shop</a></li>  
